...
For more information on automatic deployment in _tic_, take a look [at the "Deployment" article](deployment.html).
...
- You are less dependent from all the changes that are being made to the R setup for Travis or Appveyor.
...
More information about the complete workflow can be found in the ["Build lifecyle" article](build-lifecycle.html).
