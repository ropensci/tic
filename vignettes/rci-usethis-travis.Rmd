---
title: "rci, travis and usethis - an overview"
author: "Patrick Schratz, Kirill Müller"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{rci, travis and usethis - an overview}
...
The following diagram shows how the packages *rci*, *travis* and *usethis* are connected:

```{r, echo = FALSE, fig.align='center', dpi = 60}
knitr::include_graphics("img/rci-travis-usethis.png")
```
...
The latter effectively calls a mixture of *travis* and *rci* functions that do the work in the background. 
...
After everything is set up, *usethis* and *travis* have done their jobs and the rest of the work goes to *rci*.
...
- *rci*: Package to specify the CI workflow (which stages are run, which commands are used).
