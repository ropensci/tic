...
If you are unfamiliar with the term ""Continuous Integration" (CI), we highly recommend to read the following resources first:
...
For more information on the build lifecycle see [here](build-lifecycle.html).
