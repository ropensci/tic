...
A common use case is to build your _pkgdown_ site and conditionally push changes to your repo.
This practice saves you from building the whole _pkgdown_ site locally and then committing manually all the changed files - either Travis or Appveyor will do it for you! 
