...
If your Travis build fails and you don't understand why (error messages are too unspecific, you cannot reproduce the problem locally), you can enter into the Travis build via SSH.
