...
- Switch to a different window: `crtl-b <window index>` where the indeces start with 0, 1, 2 and so on.  
- Scrolling up and down the history: `crtl-b [`. Press `q` to exit the scroll mode.  

Keep in mind that you only have 30 mins before the VM will be terminated automatically!
