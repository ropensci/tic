...
If everything is ok, it will return a list with all stages that will be run in the CI build, formatted in the `R6` class style.
...
It executed all defined stages and their corresponding steps.
...
```{r, eval = FALSE}
run_all_stages()
✔ Using existing tic stage configuration
