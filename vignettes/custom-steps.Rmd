...
Usually, there should be no need to write steps on your own. 
...
The most minimalistic version is the "Hello World" [example step](https://github.com/ropenscilabs/tic/blob/master/R/steps-base.R).
This new classs only contains a `run()` function which does nothing more than printing "Hello World" to the console.
