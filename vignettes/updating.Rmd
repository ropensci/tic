...
While these templates work for most packages that use plain R code and do not rely on system libraries (such as GDAL, xml2) or link to other languages (such as Java), R packages which do so often need manual additions in their YAML file.
