...
By this we refer to the handling of the actual CI workflow: What commands are going to be executed, which steps are run in the stages, how the deployment is handled.

So in summary, the interaction between the three packages can be described like this:
