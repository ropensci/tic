...
Here is a list that shows a rought grouping of the steps into their default stages:
...
In other words, a combination of stages and steps which are used very often to provide the user a shortcut.
