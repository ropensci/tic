...
- The whole check process is returned in a R object, making it easier to inspect eventual errros/warnings

Especially the extended log printing of errors on the CI service is a huge advantage - often enough, CI services cut log output ot the console early, omitting important information about the error. 

Here is an example of the improved log output by `rcmdcheck` including an error message:
...
─  checking running R code from vignettes ...
      ...
      ‘build-lifecycle.Rmd’ using ‘UTF-8’ ... OK
      ‘custom-steps.Rmd’ using ‘UTF-8’ ... OK
      ‘deployment.Rmd’ using ‘UTF-8’ ... OK
      ‘tic-advantages.Rmd’ using ‘UTF-8’ ... OK
      ‘tic-usethis-travis.Rmd’ using ‘UTF-8’ ... OK
      ‘tic.Rmd’ using ‘UTF-8’ ... OK
    NONE
✔  checking re-building of vignette outputs (1.8s)
✔  checking PDF version of manual (2.1s)
   
   
── R CMD check results ─────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────── tic 0.2.13.9008 ────
Duration: 33.9s
